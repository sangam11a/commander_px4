...
struct SendTopicsSubs {
	SendSubscription send_subscriptions[21] = {
...
{
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<register_ext_component_request_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<unregister_ext_component_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<config_overrides_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<arming_check_reply_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<message_format_request_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<mode_completed_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<vehicle_control_mode_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<manual_control_setpoint_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<goto_setpoint_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<differential_drive_setpoint_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<vehicle_thrust_setpoint_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<vehicle_torque_setpoint_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<actuator_motors_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<actuator_servos_s>::value * 2; // use a bit larger queue size than internal
	...
	{
			uint16_t queue_depth = uORB::DefaultQueueSize<vehicle_global_position_s>::value * 2; // use a bit larger queue size than internal
